// lib/screens/areas/add_area/add_area_flow.dart
...
/// Flujo para crear un nuevo Area.
/// Delega la UI en AddRecordScreen (genérico).
/// Si la creación tiene éxito, hace pop devolviendo el [Area] creada,
/// para que el llamador pueda autoseleccionarla si lo necesita.
class AddAreaFlow extends StatelessWidget {
  const AddAreaFlow({super.key});
    ...
    final config = AddRecordConfig(
      ...
      onSubmit: (AddFormValues values) async {
        ...
        if (data is! Map<String, dynamic>) {
          throw Exception('Respuesta inesperada creando área: $data');
        }

        final created = Area.fromJson(data);
